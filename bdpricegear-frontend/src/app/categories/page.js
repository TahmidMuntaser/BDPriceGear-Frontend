              ...
              <div className="relative bg-red-900/20 backdrop-blur-xl border border-red-800/30 rounded-xl p-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h3 className="text-red-300 font-semibold mb-2">Error Loading Categories</h3>
                  ...
                  >
                    ...
                    <div className="relative text-center">
                      ...
                      <div className="mb-4 flex items-center justify-center">
                        <div 
                          className="w-20 h-20 bg-gradient-to-br from-blue-500 to-purple-600 rounded-2xl flex items-center justify-center text-3xl"
                        >
                          📁
                        </div>
                      </div>
                      
                      <h3 className="font-semibold text-white mb-2 text-lg group-hover/card:text-blue-300 transition-colors">
                        {category.name}
                      </h3>
